...
import Mycar from './app/src/view/screens/Mycar'
import MyInterest from './app/src/view/screens/MyInterest'
import Checker from './app/src/view/screens/Checker'
import Approve from "./app/src/view/screens/Approve";
import {
    NavigationParams,
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator screenOptions={{ header: () => null }} >
                ...
                <Stack.Screen name="myins" component={MyInterest} />
                <Stack.Screen name="Check" component={Checker} />
